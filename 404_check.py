...
from telegram.ext import Updater, CommandHandler, CallbackContext  # Updated imports
...
# === /track COMMAND ===
def start(update: Update, context: CallbackContext):  # Made synchronous
...
def track(update: Update, context: CallbackContext):  # Made synchronous
...
def main():
    ...
    # Start the click checker in an async loop
    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)
    loop.run_until_complete(check_clicks())
    loop.close()
